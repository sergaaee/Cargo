...
from .views import order_list_manager, order_new_searching, delete_photo_order, order_new_production, order_new_buying, order_list, order_edit, order_delete, order_edit_manager
